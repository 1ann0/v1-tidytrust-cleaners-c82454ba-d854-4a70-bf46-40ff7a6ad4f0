  	...
  	extend: {
        ...
        brand: {
          ...
          text: '#212529',
  			...
  			// primary is redefined for shadcn components, but we use primary.blue for custom styles
  			primary: {
  			...
  			// accent is redefined for shadcn components, but we use accent.gold for custom styles
  			accent: {
